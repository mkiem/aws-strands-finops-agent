...
echo "Building Budget Management Agent Lambda deployment package..."
...
cd $TEMP_DIR
zip -r9 ../budget-management-agent.zip .
cd -
...
echo "Deployment package created: budget-management-agent.zip"
