...
def get_budget_analysis() -> str:
    """
    Analyze all existing budgets and their performance.
    
    Returns:
        JSON string containing budget analysis data
    """
    try:
...
def get_budget_recommendations() -> str:
    """
    Generate budget recommendations based on cost analysis and spending patterns.
    
    Returns:
        JSON string containing budget recommendations
    """
    try:
