...
- **API Gateway**: `FinOpsAgentAPI` (endpoint: `https://x015blgao0.execute-api.us-east-1.amazonaws.com/prod`)
- **Amplify Application**: `FinOpsAgentUI` (URL: `https://d1qhkm9u84uoie.amplifyapp.com`)
- **Cognito User Pool**: `us-east-1_DQpPM15TX`
- **S3 Artifacts**:
  - `s3://finops-deployment-packages-062025/app.zip`
  - `s3://finops-deployment-packages-062025/dependencies.zip`
  - `s3://finops-deployment-packages-062025/finops-ui-build-debug.zip`
